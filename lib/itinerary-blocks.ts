...
export const BLOCK_FIELDS: Record<ItineraryBlockType, BlockField[]> = {
  air: [
    { key: "airline", label: "항공사 / 편명", full: true, icon: "/itinerary-icons/f-plane.png" },
  ...
  airDepart: [
    { key: "airline", label: "항공사 / 편명", icon: "/itinerary-icons/f-plane.png" },
    { key: "from", label: "출발지" },
    { key: "dateDepart", label: "출발일", date: true },
    { key: "time", label: "출발시간", time: true },
    { key: "blockDesc", label: "설명", full: true, area: true, below: true },
  ...
  text: [
    { key: "title", label: "제목", full: true, bold: true, hideLabel: true, valueStyle: { fontSize: "1.05em" } },
  ...
  image: [
    { key: "caption", label: "캡션", full: true },
    { key: "url", label: "이미지", full: true, isImage: true },
    { key: "blockDesc", label: "설명", full: true, area: true, below: true },
  ],
  ship: [
    { key: "shipName", label: "선박명", full: true, bold: true, icon: "/itinerary-icons/f-shipname.png" },
  ...
  lodging: [
    { key: "lodgeName", label: "숙소명", full: true, bold: true, icon: "/itinerary-icons/f-lodge.png" },
  ],
  tour: [
    { key: "tourImage", label: "이미지", full: true, isImage: true },
    { key: "tourName", label: "관광지", full: true, bold: true },
...
export const BLOCK_STYLE = {
  ...
  valueBox: "rounded-[10px] px-[1em] py-[0.75em] text-[0.875em] font-medium bg-[#F9FAFB] text-[#364153]",
