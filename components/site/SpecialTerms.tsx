  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white">
      <div className="border-b border-slate-100 px-6 py-4">
        <h3 className="text-[min(1.1vw,21.12px)] max-[991px]:text-[min(3.4262vw,20.5572px)] max-[501px]:text-[4.1609vw] font-bold text-navy">국외여행 특별약관 — 예약 취소 시 수수료 규정</h3>
        <ul className="mt-3 flex flex-col gap-1.5 text-[min(0.825vw,15.84px)] max-[991px]:text-[min(2.5695vw,15.417px)] max-[501px]:text-[3.1206vw] leading-relaxed text-slate-400">
      ...
      <div className="bg-[#FBFBFD] px-6 py-4">
        <p className="mb-3 text-[min(0.9075vw,17.424px)] max-[991px]:text-[min(2.8266vw,16.9596px)] max-[501px]:text-[3.4328vw] font-bold text-navy">크루즈 여행 취소 시, 다음과 같은 취소수수료가 부과됩니다.</p>
        <div className="overflow-x-auto max-[991px]:hidden">
          <table className="w-full text-[min(0.7315vw,14.0448px)] max-[991px]:text-[min(2.2784vw,13.6704px)] max-[501px]:text-[2.767vw]">
            <thead>
        ...
        <div className="hidden flex-col gap-2.5 max-[991px]:flex">
          {tiers.map((t) => (
            <div key={t.label} className="rounded-lg border border-slate-100 bg-white p-3 text-[min(0.9075vw,17.424px)] max-[991px]:text-[min(2.8266vw,16.9596px)] max-[501px]:text-[3.4328vw]">
        ...
        <p className="mt-3 text-[min(0.825vw,15.84px)] max-[991px]:text-[min(2.5695vw,15.417px)] max-[501px]:text-[3.1206vw] font-semibold text-brand">
          해당 특별약관은 일정별·지역별로 상이하니, 일정에 따른 특별약관을 반드시 확인하시기 바랍니다.
        </p>
      </div>

      <ul className="flex flex-col gap-1.5 border-t border-slate-100 px-6 py-4 text-[min(0.825vw,15.84px)] max-[991px]:text-[min(2.5695vw,15.417px)] max-[501px]:text-[3.1206vw] leading-relaxed text-slate-400">
